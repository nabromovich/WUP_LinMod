...
Here is the tesult of the scatter plot and our best fit line for our GRIP and SIMS data.  If we use our prediction value it mached that plot. 
...
```
The correlation with both ARM and GRIP together are the highest value rather than when compared to using ARM or GRIP on thier own.  
